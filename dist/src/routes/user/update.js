...
Router.put('/api/user/:id', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, _a, userName, name_1, email, age, err_1;
...
Router.put('/api/update-profile', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, imageIndex, err_3;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
