...
exports.FlightCreateRouter = void 0;
...
exports.FlightCreateRouter = Router;
Router.post('/api/flight', require_auth_1.requireAuth, require_admin_1.requireAdmin, flight_validator_1.FlightValidator, validate_request_1.validateRequest, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, flightNo, brand, origin_1, destination, arrival, departure, gateNo, terminal, baseFare, flight, err_1;
