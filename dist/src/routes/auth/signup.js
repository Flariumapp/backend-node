...
Router.post('/api/auth/signup', auth_validator_1.AuthValidator, validate_request_1.validateRequest, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, lastName, email, password, adminPassKey, existingUser, passwordHash, imageIndex, isAdmin, user, token, expiryDate, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 4, , 5]);
                _a = req.body, firstName = _a.firstName, lastName = _a.lastName, email = _a.email, password = _a.password, adminPassKey = _a.adminPassKey;
