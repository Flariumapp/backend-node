...
Router.post('/api/order', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, carts, price, pin, wallet, isValidPin, amount, order, history_2, err_1;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _a = req.body, carts = _a.carts, price = _a.price, pin = _a.pin;
